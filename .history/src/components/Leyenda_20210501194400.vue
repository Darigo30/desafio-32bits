<template>
    <div class="row">
      <div class="col-sm-4 mb-5" v-for="cantidadjuegos in juegosConStock" :key="cantidadjuegos.codigo">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn btn-primary btn-mor" @click="llamar(cantidadjuegos)">Vender</a>
          </div>
        </div>
      </div>
    </div>
